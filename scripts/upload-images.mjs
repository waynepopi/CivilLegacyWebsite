...
// Load env from apps/civil-legacy/.env
dotenv.config({ path: path.join(__dirname, '../apps/civil-legacy/.env') });
...
async function main() {
  const publicDir = path.join(__dirname, '../apps/civil-legacy/public');
