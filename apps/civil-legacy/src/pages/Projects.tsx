    ...
    <div className="max-w-[1600px] mx-auto py-32">
        ...
        <CarouselContent>
          {CONFIG.PROJECTS.slice(0, 5).map((proj, i) => (
            <CarouselItem key={i} className="md:basis-1/2 lg:basis-1/3 p-4">
              <Card className="bg-white/5 border-white/10 h-full flex flex-col hover:border-[#0077B6]/50 transition-all duration-500 rounded-[2rem] overflow-hidden text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {CONFIG.PROJECTS.map((proj, i) => (
          ...
          >
            <Card className="bg-white/5 border-white/10 hover:border-[#0077B6]/30 transition-all duration-500 rounded-[2rem] h-full text-left">
              <CardHeader className="p-8">
